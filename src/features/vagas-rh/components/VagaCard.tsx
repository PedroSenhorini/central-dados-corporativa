...
const PRIORIDADE_ESTILOS: Record<PrioridadeVaga, string> = {
...
interface VagaCardProps {
  vaga: VagaComRelacoes;
  arrastavel: boolean;
  onDragStart: (e: DragEvent<HTMLDivElement>, vagaId: string) => void;
}

export default function VagaCard({ vaga, arrastavel, onDragStart }: VagaCardProps) {
